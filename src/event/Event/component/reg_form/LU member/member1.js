    ...
    <div className="row">
        ...
        <div className="d-flex flex-column align-items-center text-center p-3 py-5">
          ...
          <div className="row mt-3">
            <div className="col-md-12">
              ...
              <label style={{marginLeft:'10px'}}> 1812020158</label>
            </div>
            </div>
      ...
      <div className="col-md-8 border-right border-top border-left border-bottom  p-1">
        <div className="p-3 py-5">
          ...
          <h4 className="text-right">i am from LU CC member</h4> <hr></hr>
          ...
          <div className="col-md-12">
              <label className="labels">Select Contest</label>
              <select style={{borderStyle:'inset',height:'30px'}}>
                <option selected>Contest name</option>
            ...
            <div className="col-md-12">
              <label className="labels" style={{fontSize:'20px'}}>Member 1 Details</label>
            </div>
